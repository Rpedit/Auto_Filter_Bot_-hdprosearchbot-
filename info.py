...
PICS_URL = (environ.get('PICS', 'https://files.catbox.moe/n5pebk.jpg')).split() #random anime girl img each time from aniwallpaper (Experimental)
PICS = (environ.get('PICS', 'https://files.catbox.moe/n5pebk.jpg')).split()  # Sample pic
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003937983754")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002623886935")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'jekejwkwkwkk')    # QR code image for payments
...
HDHUB_DOMAIN = environ.get('HDHUB_DOMAIN', 'https://new6.hdhub4u.cl')  # Default HDHub4u base domain[span_1](start_span)[span_1](end_span)
...
Bot_cmds = {
    ...
    "movie_update": "ᴏɴ ᴏғғ ᴀᴄᴄᴏʀᴅɪɴ𝘨 ʏᴏᴜʀ ɴᴇᴇᴅᴇᴅ...",
    ...
    "send": "ꜱᴇɴᴅ ᴍᴇꜱꜱᴀɢᴇ ᴛᴏ A ᴘᴀʀᴛɪᴄᴜʟᴀʀ ᴜꜱᴇʀ.",
